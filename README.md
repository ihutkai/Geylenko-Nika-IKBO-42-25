...
![Результат задачи 8](screenshots/task8.png)

Скрипт: [task8.sh](task8.sh)
...
![Результат задачи 9](screenshots/task9.png)

Скрипт: [task9.sh](task9.sh)

Входной файл: [test9_input.txt](test9_input.txt)

Выходной файл: [test9_output.txt](test9_output.txt)
...
**Условие:** написать программу, которая выводит названия всех пустых текстовых файлов в указанной директории. Директория передаётся в программу параметром.
...
![Результат задачи 10](screenshots/task10.png)

Скрипт: [task10.sh](task10.sh)
